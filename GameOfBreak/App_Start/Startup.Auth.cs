...
namespace GameOfBreak
{
    public partial class Startup
    {
        ...
        private async void CreateRoleAndUserAdminAsync () {
            ...
            // Validamos que no se encuentre el Rol de Administrador
            if (!roleManager.RoleExists("Administrador")) {
                ...
                var user = new ApplicationUser() {
                    ...
                    UserName = "Admin",
                    Email = "Admin@gameofbreak.com",
                    Calle = "Nueva esperanza",
                    NumInt = "117",
                    ID_CP = 144361,
                    FechaNacimiento = new DateTime(1995, 06, 03),
                    FechaAlta = DateTime.Now,
                };

                var result = await userManager.CreateAsync(user, "iAdministrador7.");

                // Se crea el Rol
                await roleManager.CreateAsync(new IdentityRole("Administrador"));

                // Vinculamos el Usuario y su Rol
